        ...
        <div className="flex-1 p-6">
          ...
          <header className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              />
              <button className="px-3 py-1 bg-blue-500 text-white rounded">New Message</button>
            </div>
          </header>
          ...
          <section>
            <div className="bg-white p-4 rounded shadow mb-4">
              <h2 className="font-bold">Message 1</h2>
              <p>From: user@example.com</p>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
            <div className="bg-white p-4 rounded shadow mb-4">
              <h2 className="font-bold">Message 2</h2>
              <p>From: user2@example.com</p>
              <p>Curabitur lobortis id lorem id bibendum.</p>
            </div>
            {/*  */}
          </section>
        </div>
