...
export class Seller extends Model {
  ...
  static get relationMappings() {
    ...
    return {
      ...
      customers: { relation: Model.HasManyRelation, modelClass: Customer, join: { from: "sellers.id", to: "customers.seller_id" } },
      reviews: { relation: Model.HasManyRelation, modelClass: Review, join: { from: "sellers.id", to: "reviews.seller_id" } },
